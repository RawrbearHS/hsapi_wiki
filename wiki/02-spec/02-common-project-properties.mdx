...
*In any versioned webplayer `<=1.?`<Note note="needs research" />, the value is replaced with `0.5` for normal-sized shapes
...
The following properties are arrays of objects, which are referenced project-wide
