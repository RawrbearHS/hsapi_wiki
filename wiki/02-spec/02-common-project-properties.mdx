...
the maximum threshold the player can handle, cutting off the text in the middle.<sup><i>[needs elaboration]</i></sup>
...
Used for displaying the remix badge in the drafts menu. Cannot be edited for a published draft.<sup><i>[needs verification]</i></sup>
