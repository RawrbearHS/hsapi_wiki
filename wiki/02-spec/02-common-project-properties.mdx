...
and uses a value of `1` for other shapes.*<Note note="needs verification" />
...
<PropertyData type="array" defaultValue="{}" />
...
- Project UUIDs are calculated when a project is published. This is by default, and can be changed manually.<Note note="needs verification" />
